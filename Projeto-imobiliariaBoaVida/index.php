    ...
    if(isset($_GET['page'])){
        ...
        if($_GET['page']=='usuario'){
            ...
            if(isset($_GET['action'])){
                ...
                if($_GET['action'] == 'add'){
                    require_once 'view/cadImagens.php';
                }
                if($_GET['action'] == 'listImagens'){
                    require_once 'view/listImagens.php';
                }
                ...
                if($_GET['action'] == 'excluirImg'){
                    //Chama uma função PHP que permite informar a classe e o Método que será acionado
                    $imagens = call_user_func(array('ImagensController','excluir'), $_GET['id']);  
                    require_once 'view/cadImagens.php';
                    require_once 'view/listImagens.php';
