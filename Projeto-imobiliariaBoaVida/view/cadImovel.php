        ...
        <form name="cadImovel" id="cadImovel" action="" method="post" enctype="multipart/form-data">
            <div class="card" >
                ...
                <div class="form-group form-row">
                    ...
                    <textarea class="form-control col-sm-8" name="descricao" id="descricao" required><?php echo isset($imovel)?$imovel->getDescricao():''; ?></textarea>
                </div>
                <div class="form-group form-row">
                ...
                <div class="form-group form-row">
                    ...
                    <input type="text" class="form-control col-sm-8" name="valor" id="valor" required
                    value="<?php echo isset($imovel)?$imovel->getValor():'';?>" />
                </div>
                <div class="form-group form-row">
                    <label class="col-sm-2 col-form-label text-right">Tipo:</label>
                    <select name="tipo" id="tipo" class="form-control col-sm-8" required>
